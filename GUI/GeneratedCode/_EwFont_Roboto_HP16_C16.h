...
EW_DEFINE_BITMAP_FONT( EwFont_Roboto_HP16_C16, 15, 4, 0, 16 )
  EW_FONT_GLYPH( 0x0000, 0, -11, 7, 11, 7, 0x00000000 ),
  EW_FONT_GLYPH( 0x0020, 0, 0, 0, 0, 4, 0x00000101 ),                  /* ' ' */
  EW_FONT_GLYPH( 0x0021, 1, -11, 2, 11, 4, 0x00000101 ),               /* '!' */
  EW_FONT_GLYPH( 0x0022, 1, -12, 4, 4, 5, 0x0000013F ),                /* '"' */
  EW_FONT_GLYPH( 0x0023, 0, -11, 10, 11, 10, 0x0000016C ),             /* '#' */
  EW_FONT_GLYPH( 0x0024, 0, -13, 9, 15, 9, 0x000002E5 ),               /* '$' */
  EW_FONT_GLYPH( 0x0025, 0, -11, 11, 11, 12, 0x000004A8 ),             /* '%' */
  EW_FONT_GLYPH( 0x0026, 0, -11, 10, 11, 10, 0x00000652 ),             /* '&' */
  EW_FONT_GLYPH( 0x0027, 0, -12, 2, 4, 3, 0x000007E7 ),                /* ''' */
  EW_FONT_GLYPH( 0x0028, 1, -13, 5, 17, 5, 0x000007FE ),               /* '(' */
  EW_FONT_GLYPH( 0x0029, 0, -13, 5, 17, 6, 0x000008EB ),               /* ')' */
  EW_FONT_GLYPH( 0x002A, 0, -11, 7, 7, 7, 0x000009D0 ),                /* '*' */
  EW_FONT_GLYPH( 0x002B, 0, -10, 9, 9, 9, 0x00000A75 ),                /* '+' */
  EW_FONT_GLYPH( 0x002C, 0, -2, 3, 4, 3, 0x00000B2A ),                 /* ',' */
  EW_FONT_GLYPH( 0x002D, 0, -5, 5, 1, 4, 0x00000B54 ),                 /* '-' */
  EW_FONT_GLYPH( 0x002E, 1, -2, 2, 2, 4, 0x00000B6E ),                 /* '.' */
  EW_FONT_GLYPH( 0x002F, 0, -11, 7, 12, 7, 0x00000B7D ),               /* '/' */
  EW_FONT_GLYPH( 0x0030, 0, -11, 9, 11, 9, 0x00000C4A ),               /* '0' */
  EW_FONT_GLYPH( 0x0031, 1, -11, 5, 11, 9, 0x00000D69 ),               /* '1' */
  EW_FONT_GLYPH( 0x0032, 0, -11, 9, 11, 9, 0x00000DD3 ),               /* '2' */
  EW_FONT_GLYPH( 0x0033, 0, -11, 8, 11, 9, 0x00000F14 ),               /* '3' */
  EW_FONT_GLYPH( 0x0034, 0, -11, 9, 11, 9, 0x00001052 ),               /* '4' */
  EW_FONT_GLYPH( 0x0035, 1, -11, 8, 11, 9, 0x0000114A ),               /* '5' */
  EW_FONT_GLYPH( 0x0036, 1, -11, 8, 11, 9, 0x0000128A ),               /* '6' */
  EW_FONT_GLYPH( 0x0037, 0, -11, 9, 11, 9, 0x000013D8 ),               /* '7' */
  EW_FONT_GLYPH( 0x0038, 0, -11, 9, 11, 9, 0x000014ED ),               /* '8' */
  EW_FONT_GLYPH( 0x0039, 0, -11, 8, 11, 9, 0x00001660 ),               /* '9' */
  EW_FONT_GLYPH( 0x003A, 1, -8, 2, 8, 4, 0x000017A3 ),                 /* ':' */
  EW_FONT_GLYPH( 0x003B, 0, -8, 3, 10, 3, 0x000017D4 ),                /* ';' */
  EW_FONT_GLYPH( 0x003C, 0, -8, 7, 7, 8, 0x00001826 ),                 /* '<' */
  EW_FONT_GLYPH( 0x003D, 1, -7, 7, 4, 9, 0x000018F2 ),                 /* '=' */
  EW_FONT_GLYPH( 0x003E, 1, -8, 7, 7, 8, 0x0000196E ),                 /* '>' */
  EW_FONT_GLYPH( 0x003F, 0, -11, 7, 11, 8, 0x00001A41 ),               /* '?' */
  EW_FONT_GLYPH( 0x0040, 0, -11, 14, 14, 14, 0x00001B3C ),             /* '@' */
  EW_FONT_GLYPH( 0x0041, 0, -11, 11, 11, 10, 0x00001E05 ),             /* 'A' */
  EW_FONT_GLYPH( 0x0042, 1, -11, 9, 11, 10, 0x00001F71 ),              /* 'B' */
  EW_FONT_GLYPH( 0x0043, 0, -11, 10, 11, 10, 0x00002094 ),             /* 'C' */
  EW_FONT_GLYPH( 0x0044, 1, -11, 9, 11, 11, 0x000021F1 ),              /* 'D' */
  EW_FONT_GLYPH( 0x0045, 1, -11, 8, 11, 9, 0x000022EB ),               /* 'E' */
  EW_FONT_GLYPH( 0x0046, 1, -11, 8, 11, 9, 0x000023CC ),               /* 'F' */
  EW_FONT_GLYPH( 0x0047, 1, -11, 9, 11, 11, 0x00002492 ),              /* 'G' */
  EW_FONT_GLYPH( 0x0048, 1, -11, 10, 11, 11, 0x000025EF ),             /* 'H' */
  EW_FONT_GLYPH( 0x0049, 1, -11, 2, 11, 4, 0x000026A7 ),               /* 'I' */
  EW_FONT_GLYPH( 0x004A, 0, -11, 8, 11, 9, 0x000026C6 ),               /* 'J' */
  EW_FONT_GLYPH( 0x004B, 1, -11, 9, 11, 10, 0x00002777 ),              /* 'K' */
  EW_FONT_GLYPH( 0x004C, 1, -11, 8, 11, 9, 0x00002893 ),               /* 'L' */
  EW_FONT_GLYPH( 0x004D, 1, -11, 12, 11, 14, 0x00002911 ),             /* 'M' */
  EW_FONT_GLYPH( 0x004E, 1, -11, 9, 11, 11, 0x00002A78 ),              /* 'N' */
  EW_FONT_GLYPH( 0x004F, 0, -11, 11, 11, 11, 0x00002B5E ),             /* 'O' */
  EW_FONT_GLYPH( 0x0050, 1, -11, 9, 11, 10, 0x00002CC8 ),              /* 'P' */
  EW_FONT_GLYPH( 0x0051, 0, -11, 10, 13, 11, 0x00002DC3 ),             /* 'Q' */
  EW_FONT_GLYPH( 0x0052, 1, -11, 9, 11, 10, 0x00002F61 ),              /* 'R' */
  EW_FONT_GLYPH( 0x0053, 0, -11, 10, 11, 10, 0x00003083 ),             /* 'S' */
  EW_FONT_GLYPH( 0x0054, 0, -11, 10, 11, 10, 0x00003215 ),             /* 'T' */
  EW_FONT_GLYPH( 0x0055, 0, -11, 10, 11, 10, 0x000032D0 ),             /* 'U' */
  EW_FONT_GLYPH( 0x0056, 0, -11, 10, 11, 10, 0x000033AA ),             /* 'V' */
  EW_FONT_GLYPH( 0x0057, 0, -11, 14, 11, 14, 0x000034F7 ),             /* 'W' */
  EW_FONT_GLYPH( 0x0058, 0, -11, 10, 11, 10, 0x000036E9 ),             /* 'X' */
  EW_FONT_GLYPH( 0x0059, 0, -11, 10, 11, 10, 0x0000384B ),             /* 'Y' */
  EW_FONT_GLYPH( 0x005A, 0, -11, 9, 11, 10, 0x0000395C ),              /* 'Z' */
  EW_FONT_GLYPH( 0x005B, 1, -13, 4, 15, 4, 0x00003A8F ),               /* '[' */
  EW_FONT_GLYPH( 0x005C, 0, -11, 7, 12, 7, 0x00003AF2 ),               /* '\' */
  EW_FONT_GLYPH( 0x005D, 0, -13, 3, 15, 4, 0x00003BC8 ),               /* ']' */
  EW_FONT_GLYPH( 0x005E, 0, -11, 7, 5, 7, 0x00003C19 ),                /* '^' */
  EW_FONT_GLYPH( 0x005F, 0, 0, 8, 1, 7, 0x00003C95 ),                  /* '_' */
  EW_FONT_GLYPH( 0x0060, 0, -12, 4, 2, 5, 0x00003CBD ),                /* '`' */
  EW_FONT_GLYPH( 0x0061, 1, -8, 7, 8, 9, 0x00003CE1 ),                 /* 'a' */
  EW_FONT_GLYPH( 0x0062, 1, -12, 8, 12, 9, 0x00003DD2 ),               /* 'b' */
  EW_FONT_GLYPH( 0x0063, 0, -8, 8, 8, 8, 0x00003EC2 ),                 /* 'c' */
  EW_FONT_GLYPH( 0x0064, 0, -12, 8, 12, 9, 0x00003FB2 ),               /* 'd' */
  EW_FONT_GLYPH( 0x0065, 0, -8, 8, 8, 8, 0x000040A9 ),                 /* 'e' */
  EW_FONT_GLYPH( 0x0066, 0, -12, 6, 12, 6, 0x000041B3 ),               /* 'f' */
  EW_FONT_GLYPH( 0x0067, 0, -8, 8, 11, 9, 0x0000425B ),                /* 'g' */
  EW_FONT_GLYPH( 0x0068, 1, -12, 7, 12, 9, 0x0000438A ),               /* 'h' */
  EW_FONT_GLYPH( 0x0069, 1, -11, 2, 11, 4, 0x00004430 ),               /* 'i' */
  EW_FONT_GLYPH( 0x006A, -1, -11, 4, 14, 4, 0x00004466 ),              /* 'j' */
  EW_FONT_GLYPH( 0x006B, 1, -12, 8, 12, 8, 0x000044D8 ),               /* 'k' */
  EW_FONT_GLYPH( 0x006C, 1, -12, 2, 12, 4, 0x000045BF ),               /* 'l' */
  EW_FONT_GLYPH( 0x006D, 1, -8, 12, 8, 14, 0x000045E2 ),               /* 'm' */
  EW_FONT_GLYPH( 0x006E, 1, -8, 7, 8, 9, 0x000046D1 ),                 /* 'n' */
  EW_FONT_GLYPH( 0x006F, 0, -8, 9, 8, 9, 0x00004758 ),                 /* 'o' */
  EW_FONT_GLYPH( 0x0070, 1, -8, 8, 11, 9, 0x00004857 ),                /* 'p' */
  EW_FONT_GLYPH( 0x0071, 0, -8, 8, 11, 9, 0x0000495C ),                /* 'q' */
  EW_FONT_GLYPH( 0x0072, 0, -8, 5, 8, 5, 0x00004A55 ),                 /* 'r' */
  EW_FONT_GLYPH( 0x0073, 0, -8, 8, 8, 8, 0x00004AA4 ),                 /* 's' */
  EW_FONT_GLYPH( 0x0074, 0, -10, 5, 10, 5, 0x00004BB9 ),               /* 't' */
  EW_FONT_GLYPH( 0x0075, 1, -8, 7, 8, 9, 0x00004C25 ),                 /* 'u' */
  EW_FONT_GLYPH( 0x0076, 0, -8, 8, 8, 8, 0x00004C9E ),                 /* 'v' */
  EW_FONT_GLYPH( 0x0077, 0, -8, 12, 8, 12, 0x00004D73 ),               /* 'w' */
  EW_FONT_GLYPH( 0x0078, 0, -8, 8, 8, 8, 0x00004ED4 ),                 /* 'x' */
  EW_FONT_GLYPH( 0x0079, 0, -8, 8, 11, 8, 0x00004FBE ),                /* 'y' */
  EW_FONT_GLYPH( 0x007A, 0, -8, 8, 8, 8, 0x000050DE ),                 /* 'z' */
  EW_FONT_GLYPH( 0x007B, 0, -12, 6, 15, 5, 0x000051C4 ),               /* '{' */
  EW_FONT_GLYPH( 0x007C, 1, -11, 2, 13, 4, 0x0000529D ),               /* '|' */
  EW_FONT_GLYPH( 0x007D, -1, -12, 6, 15, 5, 0x000052C0 ),              /* '}' */
  EW_FONT_GLYPH( 0x007E, 1, -6, 9, 3, 11, 0x0000539E ),                /* '~' */
  EW_FONT_GLYPH( 0x00A0, 0, 0, 0, 0, 4, 0x00005415 ),
  EW_FONT_GLYPH( 0x00A1, 1, -8, 2, 11, 4, 0x00005415 ),
  EW_FONT_GLYPH( 0x00A2, 1, -10, 8, 12, 9, 0x00005454 ),
  EW_FONT_GLYPH( 0x00A3, 0, -11, 9, 11, 9, 0x00005578 ),
  EW_FONT_GLYPH( 0x00A4, 0, -11, 11, 11, 11, 0x0000569B ),
  EW_FONT_GLYPH( 0x00A5, 0, -11, 10, 11, 10, 0x00005839 ),
  EW_FONT_GLYPH( 0x00A6, 1, -11, 2, 13, 4, 0x00005997 ),
  EW_FONT_GLYPH( 0x00A7, 0, -11, 9, 15, 10, 0x000059D2 ),
  EW_FONT_GLYPH( 0x00A8, 0, -12, 6, 2, 7, 0x00005BF8 ),
  EW_FONT_GLYPH( 0x00A9, 0, -11, 12, 11, 13, 0x00005C1A ),
  EW_FONT_GLYPH( 0x00AA, 1, -11, 5, 6, 7, 0x00005E28 ),
  EW_FONT_GLYPH( 0x00AB, 0, -7, 8, 6, 8, 0x00005EA5 ),
  EW_FONT_GLYPH( 0x00AC, 1, -6, 7, 3, 9, 0x00005F49 ),
  EW_FONT_GLYPH( 0x00AD, 0, -5, 5, 1, 4, 0x00005F8E ),
  EW_FONT_GLYPH( 0x00AE, 0, -11, 12, 11, 13, 0x00005FA8 ),
  EW_FONT_GLYPH( 0x00AF, 0, -11, 7, 1, 7, 0x00006184 ),
  EW_FONT_GLYPH( 0x00B0, 1, -11, 4, 4, 6, 0x000061A6 ),
  EW_FONT_GLYPH( 0x00B1, 0, -11, 8, 11, 9, 0x000061EC ),
  EW_FONT_GLYPH( 0x00B2, 0, -11, 6, 6, 6, 0x000062BE ),
  EW_FONT_GLYPH( 0x00B3, 0, -11, 6, 6, 6, 0x00006354 ),
  EW_FONT_GLYPH( 0x00B4, 1, -12, 4, 2, 5, 0x000063E6 ),
  EW_FONT_GLYPH( 0x00B5, 1, -8, 7, 11, 9, 0x0000640B ),
  EW_FONT_GLYPH( 0x00B6, 0, -11, 7, 11, 8, 0x000064B5 ),
  EW_FONT_GLYPH( 0x00B7, 1, -7, 2, 2, 4, 0x00006560 ),
  EW_FONT_GLYPH( 0x00B8, 0, 0, 4, 3, 4, 0x00006573 ),
  EW_FONT_GLYPH( 0x00B9, 1, -11, 3, 6, 6, 0x0000659D ),
  EW_FONT_GLYPH( 0x00BA, 0, -11, 7, 6, 7, 0x000065D4 ),
  EW_FONT_GLYPH( 0x00BB, 0, -7, 8, 6, 8, 0x0000666A ),
  EW_FONT_GLYPH( 0x00BC, 1, -11, 11, 11, 12, 0x0000670A ),
  EW_FONT_GLYPH( 0x00BD, 1, -11, 11, 11, 12, 0x0000686E ),
  EW_FONT_GLYPH( 0x00BE, 0, -11, 12, 11, 12, 0x000069E3 ),
  EW_FONT_GLYPH( 0x00BF, 0, -8, 8, 11, 8, 0x00006BB4 ),
  EW_FONT_GLYPH( 0x00C0, 0, -14, 11, 14, 10, 0x00006CA3 ),
  EW_FONT_GLYPH( 0x00C1, 0, -14, 11, 14, 10, 0x00006E56 ),
  EW_FONT_GLYPH( 0x00C2, 0, -14, 11, 14, 10, 0x0000700A ),
  EW_FONT_GLYPH( 0x00C3, 0, -15, 11, 15, 10, 0x000071D0 ),
  EW_FONT_GLYPH( 0x00C4, 0, -14, 11, 14, 10, 0x000073AC ),
  EW_FONT_GLYPH( 0x00C5, 0, -15, 11, 15, 10, 0x00007565 ),
  EW_FONT_GLYPH( 0x00C6, -1, -11, 16, 11, 15, 0x00007747 ),
  EW_FONT_GLYPH( 0x00C7, 0, -11, 10, 14, 10, 0x00007923 ),
  EW_FONT_GLYPH( 0x00C8, 1, -14, 8, 14, 9, 0x00007AC8 ),
  EW_FONT_GLYPH( 0x00C9, 1, -14, 8, 14, 9, 0x00007BE7 ),
  EW_FONT_GLYPH( 0x00CA, 1, -14, 8, 14, 9, 0x00007D07 ),
  EW_FONT_GLYPH( 0x00CB, 1, -14, 8, 14, 9, 0x00007E39 ),
  EW_FONT_GLYPH( 0x00CC, -1, -14, 4, 14, 4, 0x00007F5E ),
  EW_FONT_GLYPH( 0x00CD, 1, -14, 4, 14, 4, 0x00007FC5 ),
  EW_FONT_GLYPH( 0x00CE, 0, -14, 5, 14, 4, 0x0000802D ),
  EW_FONT_GLYPH( 0x00CF, -1, -14, 6, 14, 4, 0x000080B5 ),
  EW_FONT_GLYPH( 0x00D0, 0, -11, 10, 11, 11, 0x0000813E ),
  EW_FONT_GLYPH( 0x00D1, 1, -15, 9, 15, 11, 0x00008279 ),
  EW_FONT_GLYPH( 0x00D2, 0, -14, 11, 14, 11, 0x000083C7 ),
  EW_FONT_GLYPH( 0x00D3, 0, -14, 11, 14, 11, 0x00008578 ),
  EW_FONT_GLYPH( 0x00D4, 0, -14, 11, 14, 11, 0x0000872A ),
  EW_FONT_GLYPH( 0x00D5, 0, -15, 11, 15, 11, 0x000088EE ),
  EW_FONT_GLYPH( 0x00D6, 0, -14, 11, 14, 11, 0x00008AC8 ),
  EW_FONT_GLYPH( 0x00D7, 0, -9, 8, 7, 9, 0x00008C7F ),
  EW_FONT_GLYPH( 0x00D8, 0, -12, 11, 13, 11, 0x00008D5E ),
  EW_FONT_GLYPH( 0x00D9, 0, -14, 10, 14, 10, 0x00008F4E ),
  EW_FONT_GLYPH( 0x00DA, 0, -14, 10, 14, 10, 0x0000906C ),
  EW_FONT_GLYPH( 0x00DB, 0, -14, 10, 14, 10, 0x0000918B ),
  EW_FONT_GLYPH( 0x00DC, 0, -14, 10, 14, 10, 0x000092BC ),
  EW_FONT_GLYPH( 0x00DD, 0, -14, 10, 14, 10, 0x000093E0 ),
  EW_FONT_GLYPH( 0x00DE, 1, -11, 8, 11, 9, 0x00009536 ),
  EW_FONT_GLYPH( 0x00DF, 1, -12, 9, 12, 10, 0x0000960E ),
  EW_FONT_GLYPH( 0x00E0, 1, -11, 7, 11, 9, 0x00009744 ),
  EW_FONT_GLYPH( 0x00E1, 1, -11, 7, 11, 9, 0x00009870 ),
  EW_FONT_GLYPH( 0x00E2, 1, -11, 7, 11, 9, 0x0000999D ),
  EW_FONT_GLYPH( 0x00E3, 1, -12, 7, 12, 9, 0x00009ADC ),
  EW_FONT_GLYPH( 0x00E4, 1, -11, 7, 11, 9, 0x00009C2D ),
  EW_FONT_GLYPH( 0x00E5, 1, -12, 7, 12, 9, 0x00009D5F ),
  EW_FONT_GLYPH( 0x00E6, 0, -8, 14, 8, 14, 0x00009EB6 ),
  EW_FONT_GLYPH( 0x00E7, 0, -8, 8, 11, 8, 0x0000A087 ),
  EW_FONT_GLYPH( 0x00E8, 0, -11, 8, 11, 8, 0x0000A1BA ),
  EW_FONT_GLYPH( 0x00E9, 0, -11, 8, 11, 8, 0x0000A302 ),
  EW_FONT_GLYPH( 0x00EA, 0, -11, 8, 11, 8, 0x0000A44B ),
  EW_FONT_GLYPH( 0x00EB, 0, -11, 8, 11, 8, 0x0000A5A6 ),
  EW_FONT_GLYPH( 0x00EC, -1, -11, 4, 11, 4, 0x0000A6F4 ),
  EW_FONT_GLYPH( 0x00ED, 1, -11, 4, 11, 4, 0x0000A751 ),
  EW_FONT_GLYPH( 0x00EE, -1, -11, 5, 11, 4, 0x0000A7AF ),
  EW_FONT_GLYPH( 0x00EF, -1, -11, 6, 11, 4, 0x0000A82A ),
  EW_FONT_GLYPH( 0x00F0, 0, -12, 9, 12, 9, 0x0000A8A3 ),
  EW_FONT_GLYPH( 0x00F1, 1, -12, 7, 12, 9, 0x0000AA28 ),
  EW_FONT_GLYPH( 0x00F2, 0, -11, 9, 11, 9, 0x0000AB0F ),
  EW_FONT_GLYPH( 0x00F3, 0, -11, 9, 11, 9, 0x0000AC4F ),
  EW_FONT_GLYPH( 0x00F4, 0, -11, 9, 11, 9, 0x0000AD90 ),
  EW_FONT_GLYPH( 0x00F5, 0, -12, 9, 12, 9, 0x0000AEE3 ),
  EW_FONT_GLYPH( 0x00F6, 0, -11, 9, 11, 9, 0x0000B04A ),
  EW_FONT_GLYPH( 0x00F7, 0, -10, 9, 9, 9, 0x0000B190 ),
  EW_FONT_GLYPH( 0x00F8, 0, -9, 9, 10, 9, 0x0000B24A ),
  EW_FONT_GLYPH( 0x00F9, 1, -11, 7, 11, 9, 0x0000B39E ),
  EW_FONT_GLYPH( 0x00FA, 1, -11, 7, 11, 9, 0x0000B452 ),
  EW_FONT_GLYPH( 0x00FB, 1, -11, 7, 11, 9, 0x0000B507 ),
  EW_FONT_GLYPH( 0x00FC, 1, -11, 7, 11, 9, 0x0000B5CE ),
  EW_FONT_GLYPH( 0x00FD, 0, -11, 8, 14, 8, 0x0000B688 ),
  EW_FONT_GLYPH( 0x00FE, 1, -12, 8, 15, 9, 0x0000B7E7 ),
  EW_FONT_GLYPH( 0x00FF, 0, -11, 8, 14, 8, 0x0000B904 ),

  EW_FONT_PIXEL( EwFont_Roboto_HP16_C16, 0x0000BA68 )           /* ratio 74.11 % */
  ...
  EW_FONT_KERNING_CODES( EwFont_Roboto_HP16_C16 )
  EW_FONT_KERNING_VALUES( EwFont_Roboto_HP16_C16 )
EW_END_OF_BITMAP_FONT( EwFont_Roboto_HP16_C16 )
