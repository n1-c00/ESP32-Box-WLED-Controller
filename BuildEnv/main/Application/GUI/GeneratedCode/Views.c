...
static const XStringRes _Const0003 = { _StringsDefault0, 0x004B };
  ...
  if ( _this->OverflowWarning && _this->reparsed )
  {
        ...
        _this->Super1.Bounds )))
    {
      ...
      if ( _this->Super2.Owner != 0 )
        EwTrace( "%s%$%s", EwConcatString( EwConcatString( EwLoadString( &_Const0001 ), 
          s ), EwLoadString( &_Const0002 )), EwClassOf(((XObject)_this->Super2.Owner )), 
      ...
      != 0 ))
  {
    ...
    if ( noOfRows > maxNoOfRows )
    {
      ...
      if ( clipF )
      {
        ...
        tmp = EwShareString( EwConcatString( EwConcatString( EwLoadString( &_Const0005 ), 
        EwStringMiddle( res, inxF, len )), EwLoadString( &_Const0005 )));
      ...
      if ( clipL && ( inxL >= inxF ))
      {
        ...
        XString tmp2 = EwShareString( EwConcatString( EwConcatString( EwLoadString( 
          &_Const0005 ), EwStringMiddle( res, inxL, len )), EwLoadString( &_Const0005 )));
